...
7. Wait for the pruned DigiByte node to synchronize.
8. Configure Bitaxe with port `3256`, your DGB address plus `.bitaxe601`, and password `x`.

Version 1.0.1 fixes the `web_1` read-only nested bind-mount startup failure present in 1.0.0.
